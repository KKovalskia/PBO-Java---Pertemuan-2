...
public class TipeDataJava {
    public static void main(String[] args) {
        ...
        System.out.println("\nMasukkan nilai untuk variabel b (short): ");
        variabelTipeShort = input.nextShort();
        
        System.out.println("\nMasukkan nilai untuk variabel c (int): ");
        variabelTipeInterger = input.nextInt();
        
        System.out.println("\nMasukkan nilai untuk variabel d (long): ");
        variabelTipeLong = input.nextLong();
        
        System.out.println("\nMasukkan nilai untuk variabel e (float): ");
        variabelTipeFloat = input.nextFloat();
        
        System.out.println("\nMasukkan nilai untuk variabel f (double): ");
