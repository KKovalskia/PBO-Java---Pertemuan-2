...
public void lihatLaporanKeuangan() {
    ...
    System.out.println("Modal Berjalan (jika modalBerjalan =  modalAwal + keuntungan, sesuai pada ketentuan nomor 1): " + (modalAwal + keuntungan));
}
    ...
    public static void main(String[] args) {
        ...
        System.out.println("* By: Muhammad Kholid Wirautama, 22201177");
        System.out.println("***********************************************");
        System.out.println();
